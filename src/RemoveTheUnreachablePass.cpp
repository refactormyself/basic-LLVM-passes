...
PreservedAnalyses RemoveUnreachablePass::run(Function &Funct,
...
llvm::PassPluginLibraryInfo getRemoveUnreachablePluginInfo() {
            ...
            PB.registerPipelineParsingCallback(
                [](StringRef Name,
                  ...
                  if (Name == "remove-unreachable") {
                    FPM.addPass(RemoveUnreachablePass());
                    return true;
                  }
                  return false;
                });
...
llvmGetPassPluginInfo() {
  return getRemoveUnreachablePluginInfo();
}
